...
namespace WebApplication5
{
    public class BookContext:DbContext
    {
        ...
        {
            string dbName = "BookStore2";
            this.Database.Connection.ConnectionString = "Data Source=DESKTOP-EEEV4GK\\SQLEXPRESS;Initial Catalog=" + dbName + ";Trusted_Connection=Yes";
        }
