...
namespace WebApplication5.Controllers
{
    public class HoaDonController : Controller
    {
        ...
        //public ActionResult TimKiem(string maDH,string ngayTao)
        //{
        //    tk = 1;
        //    try
        //    {
        ...
        //            Session["ListHD"] = db.HoaDon.Where(i => i.DaThanhToan == true && i.flag == true && i.MaDonHang == ma).OrderByDescending(i => i.NgayTao).ToList();
        ...
        //            Session["ListHD"] = db.HoaDon.Where(i => i.DaThanhToan == true && i.flag == true && i.NgayTao.Year == year && i.NgayTao.Month == month && i.NgayTao.Day == day).OrderByDescending(i => i.NgayTao).ToList();
        ...
        //            int day = Convert.ToInt32(arr[2]);
        //            int ma = Convert.ToInt32(maDH);
        //            Session["ListHD"] = db.HoaDon.Where(i => i.DaThanhToan == true && i.flag == true && i.NgayTao.Year == year && i.NgayTao.Month == month && i.NgayTao.Day == day && i.MaDonHang == ma).OrderByDescending(i => i.NgayTao).ToList();
